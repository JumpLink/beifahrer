...
export default defineBackground(() => {
  // Every listener is registered synchronously, at the top: an MV3 service worker that wakes for
  // an event only delivers it to listeners that exist before the first await.
  install();
